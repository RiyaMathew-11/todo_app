app_name = "todo_app"
app_title = "Todo App"
app_publisher = "Riya Mathew"
app_description = "An App to manage my to-dos, set reminders and catch up with work."
app_email = "riyapmathew2000@gmail.com"
app_license = "mit"
# required_apps = []
